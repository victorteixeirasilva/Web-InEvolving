...
export default function Categoria( ) {
    ...
    const cadastrarSonho = async () => {
        ...
        const response = await fetch('https://api.inevolving.inovasoft.tech/auth/api/motivation/dreams', {
                method: 'POST',
                headers: {
    ...
    const pegarSonhos = useCallback(async () => {
        ...
        const response = await fetch('https://api.inevolving.inovasoft.tech/auth/api/motivation/dreams/user', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
