...
export default function Categoria( ) {
    ...
    const cadastrarLivro = async () => {
        ...
        const response = await fetch('http://127.0.0.1:2327/auth/api/books', {
                method: 'POST',
                headers: {
    ...
    const pegarLivrosTodo = async () => {
        ...
        const response = await fetch('http://127.0.0.1:2327/auth/api/books/status/todo', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
    ...
    const pegarLivrosProgress = async () => {
        ...
        const response = await fetch('http://127.0.0.1:2327/auth/api/books/status/progress', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
    ...
    const pegarLivrosDone = async () => {
        ...
        const response = await fetch('http://127.0.0.1:2327/auth/api/books/status/completed', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
