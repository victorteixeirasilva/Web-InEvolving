...
export default function Categoria( ) {
    ...
    const cadastrarLivro = async () => {
        ...
        const response = await fetch( linkApi + '/auth/api/books', {
                method: 'POST',
                headers: {
    ...
    const pegarLivrosTodo = useCallback(async () => {
        ...
        const response = await fetch(linkApi + '/auth/api/books/status/todo', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
    ...
    const pegarLivrosProgress = useCallback(async () => {
        ...
        const response = await fetch(linkApi + '/auth/api/books/status/progress', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
    ...
    const pegarLivrosDone = useCallback(async () => {
        ...
        const response = await fetch(linkApi + '/auth/api/books/status/completed', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + localStorage.getItem('token')
