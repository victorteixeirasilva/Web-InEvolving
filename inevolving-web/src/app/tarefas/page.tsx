...
export default function Tarefas() {
    ...
    const [primeiroCarregamento] = useState(true);
    ...
    const [filtroAtivoStatus] = useState(1);
    ...
    const [opcaoDeVisualizacao, setOpcaoDeVisualizacao] = useState(2);
