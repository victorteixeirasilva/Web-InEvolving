...
export const linkWpp = "https://api.whatsapp.com/send/?phone=%2B5511963695485&text&type=phone_number&app_absent=0";
export const linkApiDashboard = "https://api.inevolving.inovasoft.tech/auth/api/dashboard";
