                            ...
                            <div className={styles.inputs}>
                                ...
                                <motion.div className={styles.inputDescrição}>
                                    ...
                                    <div className={styles.containerStatus}>
                                        <motion.div
                                            style={status === "TO DO" ? { backgroundColor: '#6b6b6b', color: '#FFF' } : { backgroundColor: corBackgroundInput, color: '#0B0E31'}} 
                                        ...
                                        <motion.div
                                            style={status === "IN PROGRESS" ? { backgroundColor: '#a0ff47' } : { backgroundColor: corBackgroundInput, color: '#0B0E31'}} 
                                            className={styles.status}
                                        ...
                                        <motion.div 
                                            style={status === "COMPLETED" ? { backgroundColor: '#319f43', color: '#FFF' } : { backgroundColor: corBackgroundInput, color: '#0B0E31'}} 
                                            className={styles.status}
